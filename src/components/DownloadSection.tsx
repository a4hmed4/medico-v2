...
const DownloadSection: React.FC = () => {
  return (
    <div id="download" className="bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-xl text-gray-500 dark:text-gray-400 max-w-3xl mx-auto">
            Experience the future of healthcare in your pocket. Get instant AI-powered diagnoses and X-ray analysis anytime, anywhere.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mt-6 text-lg font-medium text-gray-900 dark:text-white">Easy to Use</h3>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mt-6 text-lg font-medium text-gray-900 dark:text-white">Instant Results</h3>
            <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="mt-6 text-sm text-gray-500 dark:text-gray-400">
            Version 1.0.0 • 25MB • Android 6.0 and up
          </p>
        </div>
      </div>
    </div>
